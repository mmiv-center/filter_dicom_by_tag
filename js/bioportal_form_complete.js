...
function bpMinVersion(min, actual) {
  ...
  function bpQuickJumpOnLoad() {
    jQuery(document).ready(function() {
        ...
        jQuery("#bp_quick_jump").append("<input type=\"textbox\" class=\"form-control\" id=\"" + jumpTo_searchBoxID + "\" size=\"30\" placeholder=\"Search for a known DICOM related entry, or define your own.\">");
